...
view_hport[0] = _h;
view_camera[0] = camera_create_view(0, 0, _w / 2, _h, 0, global.Player1_0, -1, -1, _w, _h);

// Set uCharacterSelec_Pcamera for view[0] (player 2)
view_visible[1] = true;
view_xport[1] = _w / 2; // Offset the second view for player two within the game window
view_yport[1] = 0;
view_wport[1] = _w / 2;
view_hport[1] = _h;
view_camera[1] = camera_create_view(0, 0, _w / 2, _h, 0, global.Player2_0, -1, -1, _w, _h);
